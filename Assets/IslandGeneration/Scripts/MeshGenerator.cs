...
public class MeshGenerator : MonoBehaviour {
    ...
    public float PointSpacing => boundsSize / (numPointsPerAxis - 1);
    public Vector3 WorldBounds => new Vector3(numChunks.x, numChunks.y, numChunks.z) * boundsSize;
    public int NumPoints => numPointsPerAxis * numPointsPerAxis * numPointsPerAxis;
    public int NumEdges => 3 * numPointsPerAxis * numPointsPerAxis * (numPointsPerAxis - 1);
